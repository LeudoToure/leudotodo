using leudotodo.Common.Models;
using leudotodo.Common.Responses;
using leudotodo.Functions.Entities;
...
namespace leudotodo.Functions.Functions
{
    public static class TodoApi
    {
        ...
        ILogger log)
        {
            log.LogInformation($"Update fot todo: {id},received.");
        ...
        ILogger log)
        {
            log.LogInformation($"Get atodo by id: {id} received");
